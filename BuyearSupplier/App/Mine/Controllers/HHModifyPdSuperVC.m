...
@interface HHModifyPdSuperVC ()<UIScrollViewDelegate,SGSegmentedControlDelegate,UISearchBarDelegate>
...
@implementation HHModifyPdSuperVC
...
- (void)viewDidLoad {
    ...
    self.title_arr = [NSMutableArray arrayWithArray:@[@"登录密码",@"安全密码"]];
...
- (void)setupChildViewController {
        ...
        HHEditPwdVC *vc = [HHEditPwdVC new];
        [self addChildViewController:vc];
    
       HHSecurityVC *vc1 = [HHSecurityVC new];
...
- (void)showVc:(NSInteger)index {
    ...
    HHEditPwdVC *vc = self.childViewControllers[index];
